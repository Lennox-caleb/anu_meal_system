...
<title>Notifications | ANU Admin</title>
...
.notif-page-item {
    ...
    display:flex; gap:14px; align-items:flex-start; transition:box-shadow .2s;
}
.notif-page-item:hover { box-shadow:0 4px 18px rgba(0,0,0,.12); }
...
<div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
    <div>
        ...
        <div class="text-muted small"><?= $unread ?> unread &nbsp;|&nbsp; Last 50 shown</div>
    </div>
    <?php if ($unread > 0): ?>
...
<?php foreach ($notifs as $n):
    ...
    $link  = $n['link'] ?: '#';
?>
<a href="<?= htmlspecialchars($link) ?>" class="notif-page-item <?= $cls ?> text-decoration-none"
